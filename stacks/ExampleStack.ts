...
export function ExampleStack({ stack }: StackContext) {
  ...
  const api = new Api(stack, "Api", {
    ...
    routes: {
      ...
      "POST /play-quarters": "packages/functions/src/playQuarters.main",
      "POST /play-semis": "packages/functions/src/playSemis.main",
      "POST /play-final": "packages/functions/src/playFinal.main",
